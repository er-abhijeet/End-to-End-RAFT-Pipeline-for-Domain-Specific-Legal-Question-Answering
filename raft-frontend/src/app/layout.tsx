...
export const metadata: Metadata = {
  title: "RAFT / CUAD — Retrieval-Augmented Fine-Tuning for Legal Contracts",
  description:
    "A teacher-student RAFT pipeline distilling contract-clause reasoning from a 9B legal teacher into a 3B student, evaluated on CUAD.",
};
